			...
			<div class="col-xl-12 col-lg-12">
				<div class="widget widget-table widget-controls widget-payouts widget-controls--dark">
					...
					<div class="widget-controls__content" style="height: auto;">
						<div class="row">
							<div class="col-lg-6">
								<h3>Add New Tracking Status</h3>
								<div class="form-group">
									<a class="btn btn-success btn-sm mb-2 mr-3" href="<?php echo base_url().'assets/download/sample_worksheet1.xlsx'; ?>" type="button">Sample Worksheet Download</a>
								</div>
							...
							<div class="col-lg-6">
								...
								<div class="form-group">
									<a class="btn btn-success btn-sm mb-2 mr-3" href="<?php echo base_url().'assets/download/sample_worksheet.xlsx'; ?>" type="button">Sample Worksheet Download</a>
								</div>
