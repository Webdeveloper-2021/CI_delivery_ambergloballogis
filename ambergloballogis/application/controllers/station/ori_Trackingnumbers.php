...
//	         $this->ah_email->send('noreply@ambergloballogistics.com', 'demo', 
	...
	public function pdfexport() {
		...
		$html = '<!DOCTYPE html>
			...
			<body>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="'.base_url().'assets/img/amber/amberlogic.JPG" style="height:30px; ">
			<table cellspacing="0" cellpadding="0" width="729" id="printablessArea">
				<tbody>
					...
					<tr>
						...
						'.$this->fun_cutstring($senderinfo[0]->address, 25).'
					...
					<tr>
						...
						'.$this->fun_cutstring($receiverinfo[0]->address, 25).'
