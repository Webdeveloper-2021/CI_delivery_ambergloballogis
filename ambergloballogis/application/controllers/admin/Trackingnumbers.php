...
class Trackingnumbers extends CI_Controller {
	...
	public function create() {
		...
		//$title   = 'Pickup Request '.$tracking_number;
		$title   = $tracking_number;
		$content  = 'Dear '.$this->username.'.<br/>';
...
//	         $this->ah_email->send('noreply@ambergloballogistics.com', 'demo', 
		  ...
		  //$data['dest_userid'] = $this->userid;
		  //$data['dest_userlevel'] = $this->level;
...
//		  $data['message'] = 'hello world';
		//  $pusher->trigger('my-channel', 'my-event', $data);
		  ...
		  $notice_data['dest_userid'] = $this->userid;
	...
	public function update() {
		...
		/*$old_tracking_data = $this->trackingnumbers_model->get_trackingnumber($id);
		$old_sender_station = $old_tracking_data->sender_station;*/
		...
		$tracking_number = $tracking_data['tracking_number'];
		$title   = $tracking_number;
		$content  = 'Dear '.$station_name.'.<br/>';
		$content .= 'You received a '.$tracking_number.'.<br/>';
		$link =  base_url().'station/Trackingnumbers/show_trackingnumber_detail?query='.$tracking_number;
		$content .= 'You may login to the system to find out more or <a href="'.$link.'">click here</a>.<br/>';
		$content .= 'From<br/>Notification.'; 
...
//		  $pusher->trigger('my-app-development', 'my-event', $data);
		  ...
		  $notice_data['dest_userid'] 		= $station_userid;
		  $notice_data['dest_userlevel'] 	= $station_level;
	...
	public function pdfexport() {
		...
		$html = '<!DOCTYPE html>
			...
			<body>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="'.base_url().'assets/img/amber/amberlogic.JPG" style="height:50px; ">
			<table cellspacing="0" cellpadding="0" width="729" id="printablessArea">
				<tbody>
					...
					<tr>
						...
						'.$this->fun_cutstring($senderinfo[0]->city.', '.$senderinfo[0]->state.', '.$senderinfo[0]->post_code, 25).'
						&nbsp;'.$senderinfo[0]->country.'
						&nbsp;
						&nbsp;<b>Contact: </b>'.$senderinfo[0]->contact_number.'
						</td>
			...
			<table cellspacing="0" cellpadding="0" width="729" id="printablessArea">
				<tbody>
					...
					<tr>
						...
						&nbsp;'.$senderinfo[0]->country.'
						&nbsp;
						&nbsp;<b>Contact:</b> '.$senderinfo[0]->contact_number.'<br>
						</td>
						<td width="150" rowspan="2" valign="top">Sender\'s Signature
						&nbsp;<br>
						&nbsp;<br>
					...
					<tr>
						...
						&nbsp;'.$receiverinfo[0]->company_name.'<br>
						'.$this->fun_cutstring($receiverinfo[0]->address, 25).'<br>
						'.$this->fun_cutstring($receiverinfo[0]->city.','.$receiverinfo[0]->state.' ,'.$receiverinfo[0]->post_code, 25).'
						&nbsp;'.$receiverinfo[0]->country.'
						&nbsp;
						&nbsp;<b>Contact:</b> '.$receiverinfo[0]->contact_number.'<br>
						</td>
						<td width="150" valign="top">&nbsp;Receiver\'s Signature
						&nbsp;<br>
						&nbsp;<br>
				...
				<tbody>
					...
					<tr>
						<td colspan="3" height="60" valign="top">
							&nbsp;'.$receiverinfo[0]->name.'<br>
							&nbsp;'.$receiverinfo[0]->company_name.'<br>
							&nbsp;'.$receiverinfo[0]->address.'
							&nbsp;'.$receiverinfo[0]->city.', '.$receiverinfo[0]->state.', '.$receiverinfo[0]->post_code.'&nbsp;'.$receiverinfo[0]->country.'
							&nbsp;Contact: '.$receiverinfo[0]->contact_number.'<br>
						</td>
					</tr>
					<tr>
...
//		$data = $this->trackingnumbers_model->fetch_data($this->userid, $this->level, $query);
	...
	public function add_trackingnumber()
	{
		...
		$this->load->view('admin/header', $maindata);
		$this->load->view('admin/trackingnumber_add', $maindata);
		$this->load->view('admin/footer', $maindata);
