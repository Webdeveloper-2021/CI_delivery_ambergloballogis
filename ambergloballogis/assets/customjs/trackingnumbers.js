...
//    		$('#tracking_number').focus;
    ...
    $(document).on("click", "#btn-save", function(e){
        ...
        $.ajax({
			...
			url: base_url + "/admin/trackingnumbers/create", 
			...
			success: function(response){
				if(response.success == 1){
                    ...
                    console.log(image);
                    table.row.add([ response.id, tracking_number, sender_station_txt, receiver_station_txt, response.status_name, response.date_stamp, response.remark, response.image_path, image, action ]).draw();
*/
					$("#form-trackingnumber").trigger('reset');
					$("#div-alert").removeAttr('style');
    ...
    $(document).on("click", ".btn-edit", function(e){
        ...
        $.ajax({
			...
			//url: "trackingnumbers/get_trackingnumber", 
			url: base_url + "admin/trackingnumbers/get_trackingnumber", 
    ...
    $(document).on("click", "#btn-update", function(e){
       ...
       /* var nLen_tracking_number 	= tracking_number.length;
        ...
        $.ajax({
			...
			url: base_url + "admin/trackingnumbers/update", 
                ...
                okay: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            ...
                            url: base_url + "admin/trackingnumbers/delete", 
    ...
    $(document).on("click", ".btn-view", function(e){
        ...
        location.href = base_url + 'admin/trackingnumbers/view?id='+id;
    ...
    $(document).on("click", ".btn-pdf", function(e){
        ...
        window.open(base_url + 'admin/trackingnumbers/pdfexport?id='+id, '_blank');
    ...
    $(document).on("click", ".btn-pdf1", function(e){
        ...
        window.open(base_url + 'admin/trackingnumbers/pdfexport1?id='+id, '_blank');
