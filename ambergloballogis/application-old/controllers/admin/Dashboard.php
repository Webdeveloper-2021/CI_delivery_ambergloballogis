...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/dashboard', $maindata);
	...
	public function get_board() {
		...
		$res= $this->trackingnumbers_model->get_board();
	...
	public function update_board() {
		...
		$data['board_description']	= $this->input->post('editor');
		$res= $this->trackingnumbers_model->update_board($data);
