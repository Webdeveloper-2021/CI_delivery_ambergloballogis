...
class Customers extends CI_Controller {
	...
	public function index()
	{
		...
		$maindata['customers']		= $this->customers_model->get_customers_limit($this->userid, $this->level);
		
		$this->load->view('station/header', $maindata);
		$this->load->view('station/customers', $maindata);
	...
	public function get_search_customer()	 {
		...
		$data = $this->customers_model->get_search_data($this->userid, $this->level, $query);
		$nLen = count($data);
	...
	public function add_customer()
	{
		...
		$maindata['name']			= $this->name;
		$maindata['parent_title']	= 'customers';
		$maindata['page_title']		= 'add_customer';
		$maindata['customers']		= $this->customers_model->get_customers_limit($this->userid, $this->level);
		
		$this->load->view('station/header', $maindata);
		$this->load->view('station/customers_new', $maindata);
		$this->load->view('station/footer', $maindata);
	}
}
