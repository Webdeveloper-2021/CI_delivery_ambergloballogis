					...
					<div class="navbar-dropdown-user-content">
						...
						<div class="dropdown-info">
							...
							<div class="dropdown-info-buttons">
								<a class="dropdown-info__viewprofile" href="<?php echo site_url('customer/profile'); ?>">View Profile</a>
							</div>
						</div>
					</div>
				...
				<div>
					...
					<ul class="sidebar-section-nav">
						<li class="sidebar-section-nav__item <?php if($page_title == 'dashboard') echo 'is-active'; ?>">
							<a class="sidebar-section-nav__link" href="<?php echo site_url('customer/dashboard'); ?>">
						...
						<li class="sidebar-section-nav__item <?php if($page_title == 'customers') echo 'is-active'; ?>">
							<a class="sidebar-section-nav__link" href="<?php echo site_url('customer/customers'); ?>">
								<span class="sidebar-section-nav__item-icon ua-icon-user"></span>
								<span class="sidebar-section-nav__item-text">Customers</span>
							</a>
						</li>
						<li class="sidebar-section-nav__item <?php if($page_title == 'trackingnumbers') echo 'is-active'; ?>">
							<a class="sidebar-section-nav__link" href="<?php echo site_url('customer/trackingnumbers'); ?>">
						...
						<li class="sidebar-section-nav__item <?php if($page_title == 'pickup_request') echo 'is-active'; ?>">
							<a class="sidebar-section-nav__link" href="<?php echo site_url('customer/pickup_request'); ?>">
								<span class="mdi mdi-clipboard-text sidebar-section-nav__item-icon"></span>
								<span class="sidebar-section-nav__item-text">Pick up Request</span>
							</a>
						</li>
						<li class="sidebar-section-nav__item <?php if($page_title == 'notifications') echo 'is-active'; ?>">
							<a class="sidebar-section-nav__link" href="<?php echo site_url('customer/Notifications'); ?>">
