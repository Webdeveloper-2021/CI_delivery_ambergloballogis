$(document).ready(function() {
    ...
    $(document).on("click", ".btn-remove", function(e){
        ...
        //var url = path + "admin/trackingnumbers/delete_notice_track";
        var url = path + "admin/Notifications/delete_notice_track";
    ...
    $(document).on("click", ".btn-view", function(e){
        ...
        var url = path + "admin/Notifications/getNoticeByTitle";
