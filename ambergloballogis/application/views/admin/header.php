	...
	<div class="collapse navbar-collapse" id="navbar-collapse">
			...
			<div class="dropdown navbar-dropdown">
				...
				<div class="dropdown-menu navbar-dropdown-menu navbar-dropdown-menu__user">
					...
					<a class="dropdown-item navbar-dropdown__item" href="" id="notice_onoff">
						<?php
							if( $this->session->userdata('email_notice_onoff') == 1)
								echo 'Turn off Notification';
							else
								echo 'Turn on Notification';
						?>
					</a>
				...
				<div>
					...
					<ul class="sidebar-section-nav">
						...
						<!--<li class="sidebar-section-nav__item <?php if($page_title == 'customers') echo 'is-active'; ?>">
							<a class="sidebar-section-nav__link" href="<?php echo site_url('admin/customers'); ?>">
						...
						<li class="sidebar-section-nav__item <?php if($parent_title == 'trackingnumbers') echo 'is-active'; ?>">
							...
							<ul class="sidebar-section-subnav" <?php if($parent_title == 'trackingnumbers') echo 'style="display: block;"'; ?>>
								...
								<li class="sidebar-section-subnav__item">
									<a class="sidebar-section-subnav__link <?php if($page_title == 'getTrackingnumbers_pickup') echo 'is-active'; ?>" href="<?php echo site_url('admin/trackingnumbers/getTrackingnumbers_pickup'); ?>">Pickup Request</a>
								</li>
								<li class="sidebar-section-subnav__item">
						...
						<li class="sidebar-section-nav__item <?php if($page_title == 'notifications') echo 'is-active'; ?>">
							<a class="sidebar-section-nav__link" href="<?php echo site_url('admin/Notifications'); ?>">
