					...
					<div class="widget-controls__content" style="height: auto;">
						<form id="form-profile">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="email" class="form-control" id="email" name="email" value="<?php echo $userinfo[0]->email; ?>" required>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<label for="vehicle_number" class="col-sm-4 col-form-label">Vehicle Number:</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" id="vehicle_number" name="vehicle_number" value="<?php echo $userinfo[0]->vehicle_number; ?>" required>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<select class="form-control" name="vehicle_type" id="vehicle_type">
										<option value="1" <?php if($userinfo[0]->vehicle_type == '1') echo 'selected'; ?>>Lorry/Truck</option>
										<option value="2" <?php if($userinfo[0]->vehicle_type == '2') echo 'selected'; ?>>Motorcycle</option>
									</select>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="zone" name="zone" value="<?php echo $userinfo[0]->zone; ?>" required>
								</div>
							</div>
							<div class="form-group row">
