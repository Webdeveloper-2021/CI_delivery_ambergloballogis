...
<div class="courier-detail">
    <section class="courier-min-detail">
        <div class="container">
            <div class="row">
                <img style="margin-left: 40%;margin-bottom: 16px;" src="https://ambergloballogistics.com/assets/img/amber/ctsilogo.jpeg" data-courier-image="12">
                ...
                <div class="hidden-sm-down col-md-4 col-lg-4">
                    <div class="detail-items">
                        <li><span class="icon"><i class="fa fa-phone"></i></span> <a
                                    ...
                                    data-anchor-protocol="tel">+603-87871303</a>
                        </li>
